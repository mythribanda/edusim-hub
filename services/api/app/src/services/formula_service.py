...
FORMULA_REGISTRY = {
    ...
    "V=U+A*T": {
        ...
        "variables": [
            {"symbol": "v", "label": "Final Velocity", "unit": "m/s", "meaning": "Final velocity"},
            {"symbol": "u", "label": "Initial Velocity", "unit": "m/s", "meaning": "Initial velocity"},
            {"symbol": "a", "label": "Acceleration", "unit": "m/s²", "meaning": "Constant acceleration"},
            {"symbol": "t", "label": "Time", "unit": "s", "meaning": "Time elapsed"}
        ],
        "resultSymbol": "v"
    },
    "AREA=PI*R^2": {
        ...
        "variables": [
            {"symbol": "Area", "label": "Area", "unit": "m²", "meaning": "Area of the circle"},
            {"symbol": "r", "label": "Radius", "unit": "m", "meaning": "Radius of the circle"}
        ],
        "resultSymbol": "Area"
    },
    "SI=(P*R*T)/100": {
        ...
        "variables": [
            {"symbol": "SI", "label": "Simple Interest", "unit": "$", "meaning": "Simple Interest earned"},
            {"symbol": "P", "label": "Principal Amount", "unit": "$", "meaning": "Principal sum"},
            {"symbol": "R", "label": "Rate of Interest", "unit": "%/yr", "meaning": "Interest rate per year"},
            {"symbol": "T", "label": "Time Period", "unit": "years", "meaning": "Duration of investment"}
        ],
        "resultSymbol": "SI"
    },
    "PE=M*G*H": {
        ...
        "variables": [
            {"symbol": "PE", "label": "Potential Energy", "unit": "J", "meaning": "Gravitational Potential Energy"},
            {"symbol": "m", "label": "Mass", "unit": "kg", "meaning": "Mass of the object"},
            {"symbol": "g", "label": "Gravitational Acceleration", "unit": "m/s²", "meaning": "Local gravity acceleration"},
            {"symbol": "h", "label": "Height", "unit": "m", "meaning": "Height from reference plane"}
        ],
        "resultSymbol": "PE"
    }
}
